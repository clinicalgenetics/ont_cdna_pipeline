...
parser.add_argument('-m', '--metadata',
                    help = "sampels metadata, tsv file",
                    dest = 'metadata', required = True)
...
config = {"samples":samples, "indir": args.input, "outdir": args.output, "ref": args.ref, "gtf": args.gtf, "metadata": args.metadata}
